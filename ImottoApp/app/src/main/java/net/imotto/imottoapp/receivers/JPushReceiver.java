package net.imotto.imottoapp.receivers;
...
public class JPushReceiver extends BroadcastReceiver {
    ...
    private void openNotification(Context context, Bundle bundle){
        ...
        try {
            ...
            openFlag = extrasJson.optInt("TYPE");
        } catch (Exception e) {
        ...
        mIntent.putExtra(Constants.BUNDLE_OPEN_FLAG, openFlag);
