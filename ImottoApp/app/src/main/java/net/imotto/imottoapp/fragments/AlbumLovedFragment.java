...
public class AlbumLovedFragment extends Fragment implements Observer {
    private static final String TAG="AlbumLoved";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        noDataHintView.setText(isLogin? R.string.lbl_no_data_loved_album:R.string.lbl_no_data_loved_album_gust);
    ...
    private void getData() {
        ...
        ImottoApi.getInstance().readLovedAlbums(uid, page, pageSize, readAlbumCompletionHandler);
    }
