...
public class UserBanActivity extends BaseBackableActivity {

    private static final String TAG="UserBan";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String title = this.getResources().getString(R.string.title_user_ban);
    ...
    private void initView(){
        ...
        noDataHintView.setText(R.string.lbl_no_data_ban);
        ...
        mAdapter.setOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(UserBanActivity.this, UserInfoActivity.class);
    ...
    private void getData(){
        ...
        ImottoApi.getInstance().readUserBans(uid, page, pageSize, readCompletionHandler);
    }
