...
public class UserFollowsActivity extends BaseBackableActivity {

    private static final String TAG="UserFollows";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String titleFormat = this.getResources().getString(R.string.title_user_follows);
        ...
        String noDataHintFmt = getString(R.string.lbl_no_data_follows);
    ...
    private void initView(){
        ...
        mAdapter.setOnItemClickListener(new RecyclerViewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(UserFollowsActivity.this, UserInfoActivity.class);
    ...
    private void getData(){
        ImottoApi.getInstance().readUserFollows(uid, page, pageSize, readCompletionHandler);
    }
