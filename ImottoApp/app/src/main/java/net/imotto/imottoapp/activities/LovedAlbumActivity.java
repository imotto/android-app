...
public class LovedAlbumActivity extends BaseBackableActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String titleFormat =this.getResources().getString(R.string.title_loved_albums);
    ...
    private void initView(){
        ...
        mAdapter.setOnAlbumActionListener(new SimpleOnAlbumActionListener(this));
    ...
    private void getData(){
        ImottoApi.getInstance().readLovedAlbums(uid, page, pageSize, readCompletionHandler);
    }
