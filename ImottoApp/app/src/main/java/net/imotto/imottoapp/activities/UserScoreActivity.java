...
import net.imotto.imottoapp.adapters.ScoreAdapter;
...
public class UserScoreActivity extends BaseBackableActivity {
    private static final String TAG="UserScore";
    private SwipeRefreshLayout mRefresh;
    private RecyclerView mRecyclerView;
    private ScoreAdapter mAdapter;
    private List<ScoreRecordModel> mData = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String titleFormat = this.getResources().getString(R.string.title_user_score);
        setupToolBar(String.format(titleFormat, "我"));

        ImageButton mSendBtn = (ImageButton) findViewById(R.id.toolbar_right_btn);
        mSendBtn.setImageResource(R.drawable.ic_user_rank);
    ...
    private void initView(){
        ...
        mAdapter = new ScoreAdapter(this, mData);
        ...
        noDataHintView.setText(R.string.lbl_no_data_score);
    ...
    private void getData(){
        ImottoApi.getInstance().readScoreRecord(page, pageSize, readCompletionHandler);
    }

    private void processResult(ReadScoreRecordResp result){
    ...
    private ImottoApi.InvokeCompletionHandler<ReadScoreRecordResp> readCompletionHandler=
            new ImottoApi.InvokeCompletionHandler<ReadScoreRecordResp>() {
                @Override
                public void onApiCallCompletion(ReadScoreRecordResp result) {
                    processResult(result);
                }

                @Override
                public Class<ReadScoreRecordResp> getGenericClass() {
                    return ReadScoreRecordResp.class;
                }
            };
}
